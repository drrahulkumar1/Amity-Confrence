        ...
        <>
            <div class="p-10 bg-surface-secondary hero mt-4">
                <div class="container-fluid pt-2 Container">
                    <div class="header">
                        <span class="tagline">International Conference <br /> on <br></br> AI 360: Driving Innovations Across Industries, Healthcare, Research and Education-2025(AIIHRE2K25)</span>
                        <p><strong >Organized by Amity School of Engineering and Technology. <br></br> Amity University Madhya Pradesh,Gwalior<br></br>Date: 28th & 29th May 2025 | Hybrid Mode</strong></p>
            ...
            <div class="container-fluid pt-2 about" id="mainabout" name="mainabout">
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <hr />
                        <h4 className="mt-4">AI 360: Driving Innovations Across Industries, Healthcare, Research and Education-2025 (AIIHRE2K25)</h4>
                        <p className="mt-4" align="justify">AIIHRE2K25 conference oﬀers rapid advancements in Arficial Intelligence (AI) are reshaping various sectors, including higher educaon. This internaonal naonal conference, tled "Integraon of Arficial Intelligence in Higher
                        ...
                        <div class="d-flex flex-row gap-3 mt-5">
                            <a className="btn btn-custom p-3 fs-5 mt-3 ms-5" href="https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FCRM2024">Paper Submission Link</a><br />
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <h2 className="display-4 text-center text-light">Keynote Speakers</h2>
                                <hr />
                            </div>
                        </div>
                        <div className="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4">
                                ...
                                <div className="card shadow-sm h-100">
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-text speaker-details">
                                            Dept. of Mathematical Sciences, Indian Institute of Technology
                            ...
                            <div className="col">
                                <div className="card shadow-sm h-100">
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-subtitle mb-2 text-muted">Professor
                                        </p>
                                        <p className="card-text speaker-details">
                            ...
                            <div className="col">
                                <div className="card shadow-sm h-100">
                                    ...
                                    />
                                    <div className="card-body text-center">
                                        <h5 className="card-title1">Prof. (Dr.) Gautam Srivastava</h5>
                                        <p className="card-subtitle mb-2 text-muted">Professor</p>
                                        <p className="card-text speaker-details">
                            ...
                            <div className="col">
                                <div className="card shadow-sm h-100">
                                    ...
                                    />
                                    <div className="card-body text-center">
                                        <h5 className="card-title1">Prof. (Dr.)Lenin Babu Russeliah</h5>
                                        <p className="card-subtitle mb-2 text-muted">Data Scientist</p>
                                        <p className="card-text speaker-details">
            ...
            <div className="container-fluid">
                <div className="our-team" id="speakers">
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <h2 className="display-4 text-center text-light">Organizing Committee</h2>
                                <hr />
                            </div>
                        </div>
                            ...
                            <div className="col">
                                <div className="card shadow-sm h-100">
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-subtitle mb-2 text-muted">Associate Professor
                                        </p>
                                        <p className="card-text speaker-details">
                                        Amity School of Engineering and Technology, Amity University Madhya Pradesh, Gwalior 
                                        </p>
                            ...
                            <div className="col">
                                <div className="card shadow-sm h-100">
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-subtitle mb-2 text-muted">Associate Professor</p>
                                        <p className="card-text speaker-details">
                                        Amity School of Engineering and Technology, Amity University Madhya Pradesh, Gwalior
                                        </p>
                                    </div>
                            ...
                            <div className="col">
                                <div className="card shadow-sm h-100">
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <p className="card-subtitle mb-2 text-muted">Assistant Professor</p>
                                        <p className="card-text speaker-details">
                                        Amity School of Engineering and Technology, Amity University Madhya Pradesh, Gwalior
                                        </p>
                                    </div>
                ...
                <div class="container schedule" id="schedule">
                    ...
                    <div class="row justify-content-center">
                        {[
                            ...
                            <div key={index} class="col-md-4 col-sm-12 col-xs-12 d-flex justify-content-center mb-4">
                                <div class="serviceBox text-center">
                                    ...
                                    <div class="service-content">
                                        ...
                                        <Link to={`/${schedule.day}`}><FaPlus /></Link>
                                    </div>
                                </div>
                            </div>
                        ))}
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-footer-widget section_padding_0_130">
                                ...
                                <p>AI 360: Driving Innovations Across Industries, Healthcare, Research and Education-2025 (AIIHRE2K25)</p>
                                <div class="copywrite-text mb-5">
                                    <p class="mb-0">Amity School of Engineering and Technology, Amity University Madhya Pradesh,Gwalior</p>
                                </div>
                            ...
                            <div class="single-footer-widget section_padding_0_130">
                                ...
                                <div class="footer_menu">
                                    <ul>
                                        ...
                                        <li><Link to="/TechnicalAdvisoryCommittee">Technical Advisory Comittee</Link></li>
                                        
                                        <li><Link to="/Progress">Technical Comittee</Link></li>
                                        <li><Link to="/organizing-committee">Program Committee</Link></li>
